%-----------------------------------------------------------------------
% Job saved on 29-May-2021 03:15:18 by cfg_util (rev $Rev: 7345 $)
% spm SPM - SPM12 (7771)
...
user = getenv('USERNAME'); % Will return the username for OSX operating systems
...
matlabbatch{1}.cfg_basicio.file_dir.file_ops.cfg_named_file.files = {
                                                                     {'C:\Users\' user '\Desktop\Flanker\sub-' subject '\func\sub-' subject '_task-flanker_run-1_bold.nii'}
                                                                     {'C:\Users\' user '\Desktop\Flanker\sub-' subject '\func\sub-' subject '_task-flanker_run-2_bold.nii'}
                                                                     }';
...
matlabbatch{4}.spm.spatial.coreg.estwrite.source = {'C:\Users\' user '\Desktop\Flanker\sub-' subject '\anat\sub-' subject '_T1w.nii,1'};
...
matlabbatch{5}.spm.spatial.preproc.tissue(1).tpm = {'C:\Users\' user '\spm12\tpm\TPM.nii,1'};
...
matlabbatch{5}.spm.spatial.preproc.tissue(2).tpm = {'C:\Users\' user '\spm12\tpm\TPM.nii,2'};
...
matlabbatch{5}.spm.spatial.preproc.tissue(3).tpm = {'C:\Users\' user '\spm12\tpm\TPM.nii,3'};
...
matlabbatch{5}.spm.spatial.preproc.tissue(4).tpm = {'C:\Users\' user '\spm12\tpm\TPM.nii,4'};
...
matlabbatch{5}.spm.spatial.preproc.tissue(5).tpm = {'C:\Users\' user '\spm12\tpm\TPM.nii,5'};
...
matlabbatch{5}.spm.spatial.preproc.tissue(6).tpm = {'C:\Users\' user '\spm12\tpm\TPM.nii,6'};
...
matlabbatch{9}.spm.stats.fmri_spec.dir = {'C:\Users\' user '\Desktop\Flanker\sub-' subject '\1stLevel'};
...
matlabbatch{9}.spm.stats.fmri_spec.sess(1).cond(1).onset = data_congruent_run1(:,1);
%%
...
matlabbatch{9}.spm.stats.fmri_spec.sess(1).cond(1).onset = data_incongruent_run2(:,1);
%%
...
matlabbatch{9}.spm.stats.fmri_spec.sess(1).cond(1).onset = data_congruent_run2(:,1);
%%
