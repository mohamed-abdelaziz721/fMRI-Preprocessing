%-----------------------------------------------------------------------
% Job saved on 29-May-2021 13:54:19 by cfg_util (rev $Rev: 7345 $)
% spm SPM - SPM12 (7771)
...
matlabbatch{1}.cfg_basicio.file_dir.file_ops.cfg_named_file.files = {
                                                                     {'C:\Users\Mohamed Abdelaziz\Desktop\Flanker\sub-04\func\sub-04_task-flanker_run-1_bold.nii'}
                                                                     {'C:\Users\Mohamed Abdelaziz\Desktop\Flanker\sub-04\func\sub-04_task-flanker_run-2_bold.nii'}
                                                                     }';
...
matlabbatch{4}.spm.spatial.coreg.estwrite.source = {'C:\Users\Mohamed Abdelaziz\Desktop\Flanker\sub-01\anat\sub-01_T1w.nii,1'};
...
matlabbatch{5}.spm.spatial.preproc.tissue(1).tpm = {'C:\Users\Mohamed Abdelaziz\spm12\tpm\TPM.nii,1'};
...
matlabbatch{5}.spm.spatial.preproc.tissue(2).tpm = {'C:\Users\Mohamed Abdelaziz\spm12\tpm\TPM.nii,2'};
...
matlabbatch{5}.spm.spatial.preproc.tissue(3).tpm = {'C:\Users\Mohamed Abdelaziz\spm12\tpm\TPM.nii,3'};
...
matlabbatch{5}.spm.spatial.preproc.tissue(4).tpm = {'C:\Users\Mohamed Abdelaziz\spm12\tpm\TPM.nii,4'};
...
matlabbatch{5}.spm.spatial.preproc.tissue(5).tpm = {'C:\Users\Mohamed Abdelaziz\spm12\tpm\TPM.nii,5'};
...
matlabbatch{5}.spm.spatial.preproc.tissue(6).tpm = {'C:\Users\Mohamed Abdelaziz\spm12\tpm\TPM.nii,6'};
...
matlabbatch{9}.spm.stats.fmri_spec.dir = {'C:\Users\Mohamed Abdelaziz\Desktop\Flanker\sub-04\1stLevel'};
...
%%
matlabbatch{9}.spm.stats.fmri_spec.sess(1).cond(2).onset = [10
                                                            30
                                                            52
                                                            64
                                                            88
...
%%
matlabbatch{9}.spm.stats.fmri_spec.sess(2).cond(1).onset = [0
                                                            42
                                                            52
                                                            76
                                                            126
...
%%
matlabbatch{9}.spm.stats.fmri_spec.sess(2).cond(2).onset = [10
                                                            20
                                                            30
                                                            64
                                                            88
